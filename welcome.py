...
WELCOME_CHANNEL_ID = 1334888995271741462
...
class Welcome(commands.Cog):
    ...
    async def on_member_join(self, member: discord.Member):
        ...
        description = (
            "Для подачи заявки в нашу семью переходите в канал <#1357057778551619824>.\n"
            ...
            "В канале <#1366898908411990026> Вы сможете получить приятный бонус за введённый промокод `/SERENITY`.\n"
