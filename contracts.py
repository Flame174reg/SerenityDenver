...
ROLE_PRIORITY: Dict[int, int] = {
    ...
    1345130001338601563: 7,
}

HIGH_STAFF_ROLE_ID = 1345130001338601563
VERIFIED_ROLE_ID = 1450355474498326538
        ...
        if not self._has_contract_access(interaction.user):
            return await self._ephemeral(
                ...
                (
                    ...
                    "Запись на контракт доступна только тем, кто отправил скриншот из F2 - Персонаж-Статистика в канал канал <#1448475080765214730>.\n"
                    "После того, как Вы получите роль <@&1450355474498326538> запишитесь ещё раз."
                ),
            )
